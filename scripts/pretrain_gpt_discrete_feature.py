...
import wandb
from pc_rl.callbacks.log_pointclouds import \
    LogGPTPointCloudWithDiscreteFeatureCallback
...
from pc_rl.models.point_gpt_discrete_feature import PointGPTDiscreteFeature
...
def main(config: DictConfig):
    ...
    masked_autoencoder = PointGPTDiscreteFeature(
        tokenizer=tokenizer,
        encoder=gpt_encoder,
        decoder=gpt_decoder,
    ...
    log_point_cloud_callback = LogGPTPointCloudWithDiscreteFeatureCallback()
